...
public class UIWrapper {
	...
	public void waitElementUntilDisplayed(WebDriver driver ,By locator){//===Wait for element until displayed==>
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofMillis(Constants.DEFAULT_WAIT_TIME));
		wait.until(ExpectedConditions.visibilityOfElementLocated(locator));
	}

	public void waitElementUntilDisplayed(WebDriver driver ,By locator, int time){//===Wait for element until displayed==>
	...
	public void waitUntillInvisible(WebDriver driver,By locator,int time){
		WebDriverWait wait = new WebDriverWait(driver,Duration.ofMillis(time));
		wait.until(ExpectedConditions.invisibilityOfElementLocated(locator));
	}
	...
	public void waitElementsUntilDisplayed(WebDriver driver ,By locator, int elementCount){//===Wait for elements until displayed==>
		WebDriverWait wait = new WebDriverWait(driver,Duration.ofMillis(Constants.DEFAULT_WAIT_TIME));
	...
	public void waitUntilPageLoad(final WebDriver driver){
		WebDriverWait wait1 = new WebDriverWait(driver, Duration.ofMillis(Constants.DEFAULT_WAIT_TIME));
